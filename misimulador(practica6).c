...
void reference (unsigned int address, unsigned int LE)
{
	...
	if (!LE) { // lectura
	  ...
	  mida_esc_mp = 1; // todos los accesos son a bytes

	  replacement = 0;
	  	  
	  if ((cache[linea_mc] == -1) || (cache[linea_mc] != tag)) miss = 1; 
	    
	  // miss de escritura
	    
	  else miss = 0; // hit de escritura
...
/*
alumne@linuxFIB:~/AC/Fibernalia> gcc CacheSimWT.o MiSimulador.c -o sim
alumne@linuxFIB:~/AC/Fibernalia> ./sim v 0
10f92150 L -> l MP:  87c90a l MC:     a TAG:10f92 byte:10 MISS L:32
10f92151 E -> l MP:  87c90a l MC:     a TAG:10f92 byte:11 HIT  E: 1
10f8a192 E -> l MP:  87c50c l MC:     c TAG:10f8a byte:12 MISS E: 1
10f92153 L -> l MP:  87c90a l MC:     a TAG:10f92 byte:13 HIT 
10f8b195 L -> l MP:  87c58c l MC:     c TAG:10f8b byte:15 MISS L:32
10f8b195 L -> l MP:  87c58c l MC:     c TAG:10f8b byte:15 HIT 
10f93156 L -> l MP:  87c98a l MC:     a TAG:10f93 byte:16 MISS L:32 -> 10f92
10f92157 E -> l MP:  87c90a l MC:     a TAG:10f92 byte:17 MISS E: 1
10f8a198 L -> l MP:  87c50c l MC:     c TAG:10f8a byte:18 MISS L:32 -> 10f8b
10f93159 E -> l MP:  87c98a l MC:     a TAG:10f93 byte:19 HIT  E: 1
12f92250 L -> l MP:  97c912 l MC:    12 TAG:12f92 byte:10 MISS L:32
10f92151 E -> l MP:  87c90a l MC:     a TAG:10f92 byte:11 MISS E: 1
10f8a192 L -> l MP:  87c50c l MC:     c TAG:10f8a byte:12 HIT 
12f92253 E -> l MP:  97c912 l MC:    12 TAG:12f92 byte:13 HIT  E: 1
10f8b195 E -> l MP:  87c58c l MC:     c TAG:10f8b byte:15 MISS E: 1
10f8b195 L -> l MP:  87c58c l MC:     c TAG:10f8b byte:15 MISS L:32 -> 10f8a
10f93156 L -> l MP:  87c98a l MC:     a TAG:10f93 byte:16 HIT 
